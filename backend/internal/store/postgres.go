...
type Store interface {
	...
	UpdateEventGroupSettings(ctx context.Context, groupID, ownerID uuid.UUID, region string, subMin int32, sortLogic string, registrationOpen bool, gameModeID uuid.UUID) error
